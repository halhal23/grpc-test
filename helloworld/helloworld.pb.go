...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x28, 0x0a, 0x08, 0x53, 0x61,
	...
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2e, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f,
...
func (c *greetingClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/Greeting/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
